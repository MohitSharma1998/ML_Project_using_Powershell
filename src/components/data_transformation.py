...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        Function responsible for data transformation of both numerical and
        categorical columns
        ...
        Returns:
            preprocessor object which can be fitted and transformed on train data
        """
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Applying preprocessor object on train and test df")
